...
\texttt{Joseph Ooi:} This is how you can refer to Figure~\ref{fig:main} and Figure~\ref{fig:sub1} or even \subref{fig:sub2} in Figure~\ref{fig:main} for example. You must make sure to keep your \verb|\label{...}| for the subfigures inside the group, \verb|{...}|, that contains \verb|\includegraphics[]{}|. If you don't, the hyperlinks will show up as \textbf{??}, as was the case in the original code. This has been fixed.
...
You may have noticed that I used the \verb|lstlisting| environment to typeset some of the \LaTeX{} examples -- with pretty-printing\footnote{Whether you agree that it \emph{is} pretty is another story altogether.}, too, including automatic line-breaking.  For more information, see the documentation for the \verb|listings| package: it's available online at \url{https://ctan.org/pkg/listings?lang=en}.
